...
const HIW = () => {
  ...
  return (
    <div className='flex flex-col items-center py-[400px]'>
        <div className='w-[50%] flex flex-col items-center mb-[300px]'>
            ...
            <motion.div className='h-[2px] bg-white pl-2' initial={{opacity: 0, left: 0, width: 0, x:-200}} whileInView={{opacity: 1, width: '45%', x:0}} transition={{ease: 'easeInOut', duration: .1}}/>
        </div>
